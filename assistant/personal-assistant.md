...
The user's active RPs are maintained in `filo-fax/ruthless-priorities/ruthless-priorities.md` (registry).
Each RP has its own file in `filo-fax/ruthless-priorities/` with definition, milestones, and progress log.
